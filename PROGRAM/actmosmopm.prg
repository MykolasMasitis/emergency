PROCEDURE  actmosmopm(lcPath, cmcod, IsVisible, IsQuit) && ŒÍÓÌ˜‡ÚÂÎ¸Ì˚È ÔÓÚÓÍÓÎ
 IF !fso.FileExists(ptempl+'\PmSPqqmmy.dot')
  MESSAGEBOX(CHR(13)+CHR(10)+'Œ“—”“—“¬”≈“ ‘¿…À PmSPqqmmy.DOT!'+CHR(13)+CHR(10),0+16,'')
  RETURN 
 ENDIF 
 ...
 DotName = pTempl + '\PmSPqqmmy.dot'
 DocName = lcPath + '\PmSP' + UPPER(m.qcod)+PADL(tMonth,2,'0')+RIGHT(STR(tYear,4),1)
