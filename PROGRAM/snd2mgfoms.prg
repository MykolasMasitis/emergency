FUNCTION Snd2MgfOMS
 ...
 IF !fso.FileExists(lcpath+'\'+m.dfile)
  MESSAGEBOX(CHR(13)+CHR(10)+'тюик яверю ме намюпсфем!'+CHR(13)+CHR(10),0+16,'')
  RETURN 
 ENDIF 
 IF !fso.FileExists(lcpath+'\'+m.ctrl)
  MESSAGEBOX(CHR(13)+CHR(10)+'тюик ньханй ме ятнплхпнбюм!'+CHR(13)+CHR(10),0+16,'')
  RETURN 
 ENDIF 
 IF !fso.FileExists(lcpath+'\'+m.prsp)
  MESSAGEBOX(CHR(13)+CHR(10)+'опнрнйнк ме ятнплхпнбюм!'+CHR(13)+CHR(10),0+16,'')
  RETURN 
 ENDIF 
 ...
 IF !fso.FileExists(lcpath+'\'+m.ssp)
  MESSAGEBOX(CHR(13)+CHR(10)+'ме сдюкняэ пюяоюйнбюрэ явер!'+CHR(13)+CHR(10),0+16,'')
  RETURN 
 ENDIF 
